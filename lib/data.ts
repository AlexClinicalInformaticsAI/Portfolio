...
// Helper function to get presentations information
export function getPresentationsInfo() {
...
// Helper function to get awards information
export function getAwardsInfo() {
  return data.credentials.awards
}
