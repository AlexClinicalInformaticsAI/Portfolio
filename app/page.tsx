  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 container mx-auto p-3 sm:p-4 pt-20 sm:pt-24 pb-6 sm:pb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <AnimatedSection animation="slide-right" delay={100}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">Clinical Expertise</h4>
                    ...
                    <AnimatedSection animation="slide-left" delay={200}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">Technical Systems</h4>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <AnimatedSection animation="slide-right" delay={300}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">Healthcare Methods</h4>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <AnimatedSection animation="slide-left" delay={400}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">Leadership Skills</h4>
                        <div className="flex flex-wrap gap-2">
        ...
        >
          <p>© {new Date().getFullYear()} Healthcare AI Consulting, LLC. All rights reserved.</p>
          <p className="mt-2">
            <a
              href="https://calendly.com/b-alex-dummett"
              target="_blank"
